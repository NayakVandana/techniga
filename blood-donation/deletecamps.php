...
<li><a href="viewsendreq.php">send request for requirement</a></li>

</ul>
<h2>Delete user</h2>

<form method="post" action="deletecamps.php">
...
if ($con)
{
	...
	{
		$id=$_POST['id'];
		$qry="delete from tbl_addcamps where id=$id";
		mysqli_query($con,$qry);
		header('location:addcamps.php');
	}
}
?>

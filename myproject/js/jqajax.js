        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = 0; i < x.length; i++) {
                    output += "<tr><td>" + x[i].id + "</td><td>" + x[i].name + "</td><td>" + x[i].email + "</td><td>" + x[i].password + "<td><td>  <button class='btn btn-warning btn-sm btn-edit' data-sid=" + x[i].id + ">Edit</button> <button class='btn btn-danger btn-sm btn-del' data-sid=" +
    ...
    $("tbody").on("click", ".btn-del", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == 1) {
                    msg = "<div class='alert alert-dark mt-3'>Student Deleted Successfull</div>";

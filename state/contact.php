...
if (isset($_POST['submit'])) {
	...
	$sql="insert into tbl_contact(name,email,mo_number,message)
	values('$name','$email','$mo_number','$message')";

	$result=mysqli_query($con,$sql);
if ($result) {

	echo " the is record inserted";
}
				...
				<form action="#" method="post">
                    ...
                    alert(err.Description);
						...
						<div class="styled-input agile-styled-input-top">
							<input type="text" name="name" onKeyPress="return onlyAlphabets(event,this);" required=""> 
						...
						<div class="styled-input">
							<input type="tel" name="mo_number" minlength="10" maxlength="10"  onkeypress="return IsNumeric(event);" ondrop="return false;"  onpaste="return false;"   required="">
							<label>Phone Number</label>
							<span></span>
						</div>

						<div class="styled-input mt-5">
							<textarea onKeyPress="return onlyAlphabets(event,this);" name="message" ></textarea>

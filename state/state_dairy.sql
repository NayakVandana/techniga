...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2022 at 02:45 AM
...
(132, 'vandunaykay0001@gmail.com', 162.00, '2021-05-24 08:10:56', '2021-05-24 08:10:56', '1'),
(133, 'vandunaykay0001@gmail.com', 50.00, '2021-05-24 08:40:47', '2021-05-24 08:40:47', '1'),
(134, 'vandunaykay0001@gmail.com', 50.00, '2021-05-24 08:45:08', '2021-05-24 08:45:08', '1'),
(135, 'vandunaykay0001@gmail.com', 202.00, '2021-05-24 08:52:56', '2021-05-24 08:52:56', '1'),
(136, 'vandunaykay0001@gmail.com', 22.00, '2021-05-25 06:56:59', '2021-05-25 06:56:59', '1'),
(137, 'vandunaykay0001@gmail.com', 22.00, '2021-05-25 07:25:23', '2021-05-25 07:25:23', '1');
...
(218, 132, 'vandunaykay0001@gmail.com', 1, 162, 1, '2021-05-24 11:40:56', 'pending'),
(219, 132, 'vandunaykay0001@gmail.com', 4, 162, 1, '2021-05-24 11:40:56', 'pending'),
(220, 132, 'vandunaykay0001@gmail.com', 2, 162, 1, '2021-05-24 11:40:56', 'pending'),
(221, 133, 'vandunaykay0001@gmail.com', 3, 50, 1, '2021-05-24 12:10:47', 'pending'),
(222, 134, 'vandunaykay0001@gmail.com', 4, 50, 1, '2021-05-24 12:15:08', 'pending'),
(223, 135, 'vandunaykay0001@gmail.com', 2, 202, 2, '2021-05-24 12:22:56', 'pending'),
(224, 135, 'vandunaykay0001@gmail.com', 1, 202, 1, '2021-05-24 12:22:56', 'pending'),
(225, 136, 'vandunaykay0001@gmail.com', 1, 22, 1, '2021-05-25 10:26:59', 'pending'),
(226, 137, 'vandunaykay0001@gmail.com', 1, 22, 1, '2021-05-25 10:55:23', 'pending');
...
INSERT INTO `response` (`response_id`, `ORDERID`, `MID`, `TXNID`, `TXNAMOUNT`, `PAYMENTMODE`, `CURRENCY`, `TXNDATE`, `STATUS`, `RESPCODE`, `RESPMSG`, `GATEWAYNAME`, `BANKTXNID`, `BANKNAME`, `CHECKSUMHASH`, `isdeleted`) VALUES
(1, 'ORDS1', 'YNsDmK65892563211994', '20210525111212800110168157402656835', '22.00', 'PPI', 'INR', '2021-05-25 10:53:03', 'TXN_SUCCESS', '01', 'Txn Success', 'WALLET', 64632044, 0, 0, b'0'),
(2, 'ORDS5', 'YNsDmK65892563211994', '20210525111212800110168191002661442', '22.00', 'PPI', 'INR', '2021-05-25 10:55:42', 'TXN_SUCCESS', '01', 'Txn Success', 'WALLET', 64632135, 0, 0, b'0');
...
CREATE TABLE IF NOT EXISTS `tbl_milk` (
...
CREATE TABLE IF NOT EXISTS `tbl_milkdistributor` (
`user_id` int(4) NOT NULL,
...
--
ALTER TABLE `orders`
 ADD PRIMARY KEY (`id`), ADD KEY `customer_id` (`email_id`);
...
--
ALTER TABLE `response`
MODIFY `response_id` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbl_milk`
MODIFY `milk_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--

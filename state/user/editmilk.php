...
">Edit Milk</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"  style="margin-left: 6%;"> 
						...
						<div class="form-body">
							...
							<form method="POST" enctype="multipart/form-data"> 
								...
								<div class="form-group"> <label for="exampleInputEmail1">Email Id</label> 
									<input type="text" name="user_id" class="form-control" value="<?php echo $user;?>" id="exampleInputEmail1" readonly> </div> 
								...
								<div class="form-group"> <label for="exampleInputPassword1">Logo</label> 
									...
									<img src="milk/<?php echo $logo;?>" style="height:100px;width:120px;display:inline;margin-right:20px;float:left;" /><br /><br />
...
move_uploaded_file($_FILES['logo']['tmp_name'], "milk/".$_FILES['logo']['name']);

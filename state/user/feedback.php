...

{
	...
	$sql = "insert into tbl_feedback(user_id,message)
	value('$user_id','$message')";
	$result=mysqli_query($con,$sql);
	if($result)
	{
	    echo "<script language='javascript'>alert('your feedback send successfully!!!!');</script>";
...
<div >
		...
		<h5 class="modal-title text-uppercase"> Feedback </h5>
		<div class="lregister-form">
			<form action="#" method="post" enctype="multipart/form-data" class="px-3 pt-3 pb-0">
				...
				<div class="form-group">
					...
					<input type="text" style="height: 32px; width:25% ; " class="form-control"  name="message" id="recipient-name3" >
				</div>

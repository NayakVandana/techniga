...
<html lang="en">
<head>
<title>State Dairy Management</title>
	...
	<div class="container">
		...
		<section class="row top_header pt-3">
			<div class="col-lg-6 buttons ml-auto">
				<p><span class="fa fa-user"></span><?php echo $email_id;?></p>
        ...
        <div id="logo">
			<h1>
				<a class="navbar-brand" href="index.php"> <span class="fa fa-empire"></span>State Dairy <span><span class="line"></span>System</span>
				</a>
			</h1>
		</div>
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu mt-2">
				...
				<li class="mr-lg-3 mr-2"><a href="product.php">Product</a></li>
				
				<li class="mr-lg-3 mr-2"><a href="milk.php">Add Milk</a></li>
				
				 <li class="mr-lg-3 mr-2"><a href="salary.php">Emp Salary List</a></li>
                ...
                <label for="drop-2" class="toggle">Assesment <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
                <a href="#">Assesment <span class="fa fa-angle-down" aria-hidden="true"></span></a>
		...
		<div class="banner-text">
			<div class="slider-info mb-4">
				<div class="banner-heading">
					<h3>
						Welcome To State Dairy System Start Here
					</h3>
				</div>
